...
namespace Developpez.MagazineTool
{
    public class Generator
    {
        ...
        private readonly string REMERCIEMENTS_FILENAME = "remerciements.tex";
        ...
        public bool InitializeOutputDirectoryHierarchy()
        {
            ...
            _sourceDirectory = Directory.CreateDirectory(@"C:\Users\fdori\Source\Repos\Developpez\MagazineTool\sources");
        ...
        public bool GenerateRemerciements()
        {
            string content = TemplateManager.RenderTemplate(REMERCIEMENTS_FILENAME, _magazine);
            string outputFileName = Path.Combine(_magazineDirectory.FullName, REMERCIEMENTS_FILENAME);
